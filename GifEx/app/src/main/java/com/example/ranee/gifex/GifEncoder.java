...
public class GifEncoder {
    ...
    public boolean addFrame(Bitmap im) {
        ...
        try {
            ...
            if (firstFrame) {
                ...
                if (repeat >= 0) {
                    // use NS app extenstion to indicate reps
                    writeNetscapeExt();
                }
            }
    ...
    /**
     * Flushed any pending data and closes output file. If writing to an
     ...
     * automatically.
     * @param os
     *          Output Stream on which GIF images are written.
    ...
    protected void writeLSD() throws IOException {
        ...
        writeShort(height);
        // packed fields
        out.write((0x80 |  // 1 : golbal color table flag = 1 (gct used)
    ...
    protected void writeNetscapeExt() throws IOException {
        out.write(0x21);    // extenstion introducer
